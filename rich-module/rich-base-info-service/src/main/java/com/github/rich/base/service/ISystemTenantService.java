...
public interface ISystemTenantService extends IService<SystemTenant> {
     ...
     * @return Boolean
     */
    String create(String userId, SystemTenant systemTenant);
     ...
     * @return Boolean
     */
    Boolean update(String userId, SystemTenant systemTenant);
     ...
     * @return Boolean
     */
    Boolean changeStatus(String userId, SystemTenant tenant);
